...
#             if "Question #:" in text:
#                 question_number = text.split("Question #:")[1].split("Topic #:")[0].strip()
#             else:
...
#         return Question(number=question_number, body=question_text, choices=choices_text)
